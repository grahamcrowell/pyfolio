...
CREATE TABLE IF NOT EXISTS trans (note CHAR(100), symbol CHAR(10), tran_date DATE, settle_date DATE, acct_currency CHAR(10), type CHAR(15), qty INTEGER, price_currency CHAR(10), price FLOAT, amount FLOAT);
...
CREATE TABLE IF NOT EXISTS prices (symbol CHAR(10), date DATE, open FLOAT, high FLOAT, low FLOAT, close FLOAT, volume INTEGER, adj_close FLOAT, PRIMARY KEY (symbol, date));
